...
public interface LibExprVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitDeclaration(LibExprParser.DeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code intDeclation}
	 * labeled alternative in {@link LibExprParser#declare}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIntDeclation(LibExprParser.IntDeclationContext ctx);
	/**
